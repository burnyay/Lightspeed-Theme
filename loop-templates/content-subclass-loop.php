...
<?php endif; ?>
	...
	<? if (get_field('full_subclass_guide')):?>
		Check out our <a href="<? the_permalink(); ?>"><? echo $subclass_name; ?> 5e guide</a>.
	<? else: ?>
		...
		<?php while( have_rows('features') ): the_row(); ?>
				...
				<?php if( have_rows('feature') ):?> <? while( have_rows('feature') ): the_row(); 
					...
					$spells = get_sub_field('spells-feature'); if ($spells): ?>
						<span class="<?php $spell_list_rating = get_sub_field( 'spell_list_rating' );  
						echo $spell_list_rating->slug; ?>"><strong><?php the_title(); ?> spells</strong></span>: <?php the_sub_field( 'spell_list_rating_text' ); ?>
